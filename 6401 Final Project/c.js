...
d3.select("ccontent").append("h2").text("Opening Market Prices VS. Closing Market Prices of Apple");
    ...
    d3.csv("AAPL.csv", function(error,data) {
      ...
      svg.selectAll("dot")
          .data(data)
        .enter().append("circle")
          .filter(function(d) { return d.Close == 174.25 ||  d.Close == 167.960007})  // <== This line
